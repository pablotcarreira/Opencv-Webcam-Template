...
class ClassifiedOutputScene(CameraOutputScene):
    ...
    def __init__(self, cameraDevice, nome="Classificada"):
        ...
        self.classificador = keras.models.load_model("modelos/cats_dogs_vgg_finetune.model")
    ...
    def _on_new_frame(self, array):
        ...
        previsao = self.classificador.predict(array_preparada, verbose=0)
        # Fim da previsao
        ...
        if 0.2 < previsao < 0.8:
            ...
            texto = "cachorro"
        print(previsao)
        self.numero.setPlainText(texto)
